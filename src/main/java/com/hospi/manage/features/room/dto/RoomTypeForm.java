...
public class RoomTypeForm {
    ...
    public RoomTypeForm(String name, Short maxOccupancy, String description, String features, BedType bedType,
                        Integer area, String views, BigDecimal basePrice, Boolean isActive) {
        this.name = name;
